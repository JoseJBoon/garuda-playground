...
from garuda_dir.sample_core_rpc import ArticleGaruda, BookGaruda, ChapterGaruda, PersonGaruda  # NOQA

class AutoGaruda(LogEntryGaruda, PermissionGaruda, GroupGaruda, UserGaruda, ContentTypeGaruda, SessionGaruda, ArticleGaruda, BookGaruda, ChapterGaruda, PersonGaruda):  # NOQA
    pass